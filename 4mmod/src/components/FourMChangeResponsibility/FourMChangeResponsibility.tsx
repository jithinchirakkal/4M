...
const FourMChangeResponsibility: React.FC = () => {
  ...
  return (
    <div className="max-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6 lg:p-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <h1 className="text-2xl md:text-3xl lg:text-3xl font-black tracking-tight">
