...
//       const target = allApprovals.find((a) => a.id === approvalId);
//       const recordId = target?.change_details?.record_id;
...
//   const openRemarkModal = (id: number, action: 'approve' | 'reject') => {
//     setRemarkModal({ show: true, approvalId: id, action });
//     setRemarks('');
//   };
...
//                           <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg border ${categoryTextColors[ch.four_m]}`}>
...
//         {/* Fixed-size non-scrollable Detail Popup */}
...
//               <div className="p-5 flex-1 overflow-hidden space-y-4 text-sm">
//                 {(() => {
...
//                   const canAct = pending && (selectedApproval.role_code === user?.role || isAdmin);
...
//                           <button
//                             onClick={() => openRemarkModal(selectedApproval.id, 'reject')}
...
//                           </button>
//                           <button
//                             onClick={() => openRemarkModal(selectedApproval.id, 'approve')}
//                             disabled={actionLoading === selectedApproval.id}
...
//                 Are you sure you want to {remarkModal.action} this request?
//               </p>
