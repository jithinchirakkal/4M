...
import styles from './sidebar.module.css';     // keep your custom scrollbar styles
import logo from '../../assets/4M (2).png';    // not shown but still import if you need it
      ...
      <div className="p-6 border-b border-gray-200/50 dark:border-gray-700/50">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="hidden md:block p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          >
            <Menu size={20} className="text-gray-600 dark:text-gray-300" />
          </button>
          ...
          {/* Close (mobile) */}
          <button
            className="block md:hidden p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            onClick={() => setMobileOpen(false)}
            aria-label="Close sidebar"
          >
            <X size={20} className="text-gray-600 dark:text-gray-300" />
