...
//   preparedBy: string;
//   approvedBy: string;
//   changePoint?: string; // Added as optional field
// }
...
//     shift: '',
//     date: '',
//     validationPoints: Array.from({ length: 10 }, () => ({
//       sn: '',
//       spec: '',
//       beforeMan1: '', beforeMan2: '', beforeMan3: '',
//       afterMan1: '', afterMan2: '', afterMan3: '',
//       endMan1: '', endMan2: '', endMan3: '',
//       remarks: ''
//     })),
//     resultConfirmation: '',
//     preparedBy: '',
...
//     handleInputChange({ target: { name: 'unexpectedChange', value: type } } as React.ChangeEvent<HTMLInputElement>, null);
//   };
...
//           </div>
//           <p className="text-blue-600 font-medium">Way of Life</p>
//         </div>

//         <div className="bg-white shadow-xl rounded-lg overflow-hidden">
//           <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white">
//             <h2 className="text-xl font-semibold">VALIDATION/VERIFICATION REPORT AFTER UNEXPECTED 4M CHANGE</h2>
//           </div>
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-1">Unexpected Change (Mark)</label>
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-1">Change Point (Detail)</label>
//                 <input
//                   type="text"
//                   name="changePoint"
...
//                   </th>
//                   <th colSpan={3} className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-blue-50 border-r border-gray-200">
...
//                   </th>
//                   <th colSpan={3} className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-green-50 border-r border-gray-200">
...
//                   </th>
//                   <th colSpan={3} className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-yellow-50">
...
//                       <input
//                         type="text"
//                         value={point.sn || (index + 1).toString()}
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">Result Confirmation Status</label>
//                 <select
