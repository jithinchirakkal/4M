...
import React, { useState, useRef, useEffect } from "react";
import { LogOut, X, HomeIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Right: Home Button and User Avatar */}
        <div className="flex items-center gap-4">
            ...
            >
              ...
              <div className="p-6">
                <button
                  onClick={handleLogout}
                  disabled={loggingOut}
                  className="w-full flex items-center justify-center gap-3 text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl py-3 px-4 shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  <LogOut size={20} strokeWidth={2.5} />
